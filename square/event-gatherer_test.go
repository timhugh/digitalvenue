...
func TestEventGatherer_GatherSuccess(t *testing.T) {
	...
	squareApi := mock.Mock[square.Client]()
...
func TestEventGatherer_GatherPaymentRepoError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, mock.Mock[square.MerchantRepository](), mock.Mock[core.OrderRepository](), mock.Mock[core.CustomerRepository](), mock.Mock[square.Client](), square.NewOrderMapper())
	err := gatherer.Gather(squaretest.SquarePaymentID)
...
func TestEventGatherer_GatherMerchantRepoError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, merchantRepo, mock.Mock[core.OrderRepository](), mock.Mock[core.CustomerRepository](), mock.Mock[square.Client](), square.NewOrderMapper())
	err := gatherer.Gather(squaretest.SquarePaymentID)
