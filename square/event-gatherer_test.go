...
func TestEventGatherer_Gather_Success(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, merchantRepo, orderRepo, customerRepo, squareApi)
...
func TestEventGatherer_Gather_PaymentRepoError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, mock.Mock[square.MerchantRepository](), mock.Mock[core.OrderRepository](), mock.Mock[core.CustomerRepository](), mock.Mock[square.APIClient]())
	err := gatherer.Gather(squaretest.SquarePaymentID)
...
func TestEventGatherer_Gather_MerchantRepoError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, merchantRepo, mock.Mock[core.OrderRepository](), mock.Mock[core.CustomerRepository](), mock.Mock[square.APIClient]())
	err := gatherer.Gather(squaretest.SquarePaymentID)
...
func TestEventGatherer_Gather_SquareFetchOrderError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, merchantRepo, mock.Mock[core.OrderRepository](), mock.Mock[core.CustomerRepository](), squareApi)
	err := gatherer.Gather(squaretest.SquarePaymentID)
...
func TestEventGatherer_Gather_CustomerRepoError(t *testing.T) {
	...
	gatherer := square.NewEventGatherer(zerolog.Logger{}, paymentRepo, merchantRepo, mock.Mock[core.OrderRepository](), customerRepo, squareApi)
	err := gatherer.Gather(squaretest.SquarePaymentID)
