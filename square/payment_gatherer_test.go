...
func TestEventGatherer_Gather_Success(t *testing.T) {
	...
	mock.WhenDouble(paymentRepo.GetSquarePayment(squaretest.SquareMerchantID, squaretest.SquarePaymentID)).ThenReturn(squaretest.NewSquarePayment(), nil)
	...
	err := gatherer.Gather(squaretest.SquareMerchantID, squaretest.SquarePaymentID)
	is.NoErr(err)
...
func TestEventGatherer_Gather_PaymentRepoError(t *testing.T) {
	...
	paymentRepo := mock.Mock[square.PaymentRepository]()
	mock.WhenDouble(paymentRepo.GetSquarePayment(squaretest.SquareMerchantID, squaretest.SquarePaymentID)).ThenReturn(&square.Payment{}, errors.New("failed to find payment"))
